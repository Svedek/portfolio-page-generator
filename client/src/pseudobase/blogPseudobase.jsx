...
const table = [
  ...
  {  // 4
    title: "Website Update and Plans",
    date: "March 28th, 2025",
    links: [],
    body:
      <>
        <p>
          Hello, I graduated university and should have more time to maintain this page! I wanted to write an update about what I've changed on this page and what I'm hoping to be doing.
        </p>
        <p>
          The original site was an entirely static page made before I learned any JavaScript, it was a collection of pages with growing lists of projects or posts. While the old site did what it needed to do, doing any further work on the site or adding new information was tedious, so I ended up deciding to remake the site using react to make it more maintainable. The site has the same aesthetic, but was a lot easier to clean up (small styling issues) and I was finally able to break up the projects and blog pages, where they show a manageable number of items per page and allow you to navigate between pages of their respective items. When I have more projects to view, I plan on also setting up some manner of filters, for example to only show projects that are major projects from the year 2024. I'm also looking into adding a light theme or alternate theme to the page so that anyone who doesn't like this theme has options. Beyond those plans, I'm pretty happy with how the site is coming along.
        </p>
        <p>
          As for my life now and plans, I hit a bit of a slump after graduating and I've been struggling to find a CS related position. I hope it's just a matter of time and applying to enough places, but I'm also trying to finish projects, start new ones, and generally continue learning new things.
        </p>
        <p>
...
const querryID = (id) => table[id];

const numItems = table.length;


export { querry, querryID, numItems };